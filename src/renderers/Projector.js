...
const Projector = function() {
	...
	_projScreenObjectMatrix = new Matrix4(),
	_frustum = [],
	...
	this.projectObjects = function ( scene, camera, sort ) {
		...
		for ( o = 0, ol = objects.length; o < ol; o ++ ) {
			...
			if ( !object.visible || ( object instanceof Mesh && !isInFrustum( object ) ) ) continue;

			_object = _objectPool[ _objectCount ] = _objectPool[ _objectCount ] || new RenderableObject();
			...
			if ( object instanceof Mesh ) {
						...
						if ( v1.__visible && v2.__visible && v3.__visible ) {
							...
							if ( ( object.doubleSided || ( object.flipSided !=
							   ...
							   ( v3.positionScreen.y - v1.positionScreen.y ) * ( v2.positionScreen.x - v1.positionScreen.x ) < 0 ) ) ) {
								...
								_face3 = _face3Pool[ _face3Count ] = _face3Pool[ _face3Count ] || new RenderableFace3();
								...
								for ( n = 0, nl = faceVertexNormals.length; n < nl; n ++ ) {
									...
									normal = _face3VertexNormals[ n ] = _face3VertexNormals[ n ] || new Vector3();
						...
						if ( v1.__visible && v2.__visible && v3.__visible && v4.__visible ) {
							...
							if ( ( object.doubleSided || ( object.flipSided !=
							   ...
							   ( v2.positionScreen.y - v3.positionScreen.y ) * ( v4.positionScreen.x - v3.positionScreen.x ) < 0 ) ) ) ) {
								...
								_face32 = _face3Pool[ _face3Count ] = _face3Pool[ _face3Count ] || new RenderableFace3();
				...
				for ( v = 1, vl = vertices.length; v < vl; v++ ) {
					...
					if ( clipLine( _clippedVertex1PositionScreen, _clippedVertex2PositionScreen ) ) {
						...
						_line = _linePool[ _lineCount ] = _linePool[ _lineCount ] || new RenderableLine();
				...
				if ( _vector4.z > 0 && _vector4.z < 1 ) {
					...
					_particle = _particlePool[ _particleCount ] = _particlePool[ _particleCount ] || new RenderableParticle();
	...
	this.unprojectVector = function ( vector, camera ) {
		...
		var matrix = Matrix4.makeInvert( camera.matrix );

		matrix.multiplySelf( Matrix4.makeInvert( camera.projectionMatrix ) );
	...
	function computeFrustum( m ) {
		...
		_frustum[ 0 ] = new Vector4( m.n41 - m.n11, m.n42 - m.n12, m.n43 - m.n13, m.n44 - m.n14 );
		_frustum[ 1 ] = new Vector4( m.n41 + m.n11, m.n42 + m.n12, m.n43 + m.n13, m.n44 + m.n14 );
		_frustum[ 2 ] = new Vector4( m.n41 + m.n21, m.n42 + m.n22, m.n43 + m.n23, m.n44 + m.n24 );
		_frustum[ 3 ] = new Vector4( m.n41 - m.n21, m.n42 - m.n22, m.n43 - m.n23, m.n44 - m.n24 );
		_frustum[ 4 ] = new Vector4( m.n41 - m.n31, m.n42 - m.n32, m.n43 - m.n33, m.n44 - m.n34 );
		_frustum[ 5 ] = new Vector4( m.n41 + m.n31, m.n42 + m.n32, m.n43 + m.n33, m.n44 + m.n34 );
