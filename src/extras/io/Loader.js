...
Loader.prototype = {
	...
	loadAscii: function ( parameters ) {
		...
		var url = parameters.model,
		    ...
		    texture_path = parameters.texture_path ? parameters.texture_path : Loader.prototype.extractUrlbase( url ),
		...
		worker.onmessage = function( event ) {
			...
			Loader.prototype.createModel( event.data, callback, texture_path );
	...
	loadBinary: function( parameters ) {
		...
		var url = parameters.model,
			callback = parameters.callback, 
		    texture_path = parameters.texture_path ? parameters.texture_path : Loader.prototype.extractUrlbase( url ),
			bin_path = parameters.bin_path ? parameters.bin_path : Loader.prototype.extractUrlbase( url ),
		...
		worker.onmessage = function( event ) {
			...
			Loader.prototype.loadAjaxBuffers( buffers, materials, callback, bin_path, texture_path, callback_progress );
		...
		xhr.onreadystatechange = function() {
			...
			if ( xhr.readyState == 4 ) {
				...
				if ( xhr.status == 200 || xhr.status == 0 ) {
					...
					Loader.prototype.createBinModel( xhr.responseText, callback, texture_path, materials );
	...
	createBinModel: function ( data, callback, texture_path, materials ) {
		...
		var Model = function ( texture_path ) {
			...
			Loader.prototype.init_materials( scope, materials, texture_path );
			...
			function add_uv3( i ) {
				...
				Loader.prototype.uv3( scope.uvs, u1, v1, u2, v2, u3, v3 );
			...
			function add_uv4( i ) {
				...
				Loader.prototype.uv4( scope.uvs, u1, v1, u2, v2, u3, v3, u4, v4 );
	...
	createModel: function ( data, callback, texture_path ) {
		...
		var Model = function ( texture_path ) {
			...
			Loader.prototype.init_materials( scope, data.materials, texture_path );
			...
			function init_faces() {
				...
				function add_uv3( src, i ) {
					...
					if( data.uvs2 ) {
						...
						Loader.prototype.uv3( scope.uvs2, u1, 1-v1, u2, 1-v2, u3, 1-v3 );
				...
				function add_uv4( src, i ) {
					...
					if( data.uvs2 ) {
						...
						Loader.prototype.uv4( scope.uvs2, u1, 1-v1, u2, 1-v2, u3, 1-v3, u4, 1-v4 );
	...
	createMaterial: function ( m, texture_path ) {
		...
		if ( m.map_lightmap && texture_path ) {
			...
			texture = document.createElement( 'canvas' );
			material.light_map = new Texture( texture );
